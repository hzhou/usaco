...
public class cownav_gold {
        ...
        public static void main(String[] args) throws IOException {
                ...
                while(!q.isEmpty()) {
                        ...
                        int count = dp[curr.ax][curr.ay][curr.ad][curr.bx][curr.by][curr.bd]-1;
                        if (count< 5) {
                            System.out.printf("%d: d=%d k1=%d k2=%d\n", count, curr.ad, curr.ay+(n-1-curr.ax)*n, curr.by+(n-1-curr.bx)*n);
                        }
